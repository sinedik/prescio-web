...
const translations = {
  ...
  // ── Portfolio / AddPositionModal ──────────────────────────────────────────────
  'portfolio.add_title':        { en: 'ADD POSITION',           ru: 'ДОБАВИТЬ ПОЗИЦИЮ' },
  'portfolio.market_question':  { en: 'MARKET QUESTION',        ru: 'ВОПРОС РЫНКА' },
  'portfolio.platform':         { en: 'PLATFORM',               ru: 'ПЛАТФОРМА' },
  'portfolio.direction':        { en: 'DIRECTION',              ru: 'НАПРАВЛЕНИЕ' },
  'portfolio.entry_price':      { en: 'ENTRY PRICE %',          ru: 'ЦЕНА ВХОДА %' },
  'portfolio.fair_prob':        { en: 'MY FAIR PROB %',         ru: 'МОЯ ВЕРОЯТНОСТЬ %' },
  'portfolio.kelly_calc':       { en: 'KELLY CALCULATOR',       ru: 'КАЛЬКУЛЯТОР КЕЛЛИ' },
  'portfolio.edge_label':       { en: 'EDGE',                   ru: 'ПРЕИМУЩЕСТВО' },
  'portfolio.full_kelly':       { en: 'FULL KELLY',             ru: 'ПОЛНЫЙ КЕЛЛИ' },
  'portfolio.half_kelly':       { en: 'HALF KELLY',             ru: 'ПОЛОВИНА КЕЛЛИ' },
  'portfolio.no_edge':          { en: 'No edge — consider skipping', ru: 'Нет преимущества — рассмотрите пропуск' },
  'portfolio.amount':           { en: 'AMOUNT $',               ru: 'СУММА $' },
  'portfolio.potential_win':    { en: 'Potential win: +$',      ru: 'Потенциальный выигрыш: +$' },
  'portfolio.topic':            { en: 'TOPIC',                  ru: 'ТЕМА' },
  'portfolio.resolution_date':  { en: 'RESOLUTION DATE',        ru: 'ДАТА РЕШЕНИЯ' },
  'portfolio.thesis':           { en: 'THESIS',                 ru: 'ТЕЗИС' },
  'portfolio.market_url':       { en: 'MARKET URL',             ru: 'ССЫЛКА НА РЫНОК' },
  'portfolio.cancel':           { en: 'CANCEL',                 ru: 'ОТМЕНА' },
  'portfolio.add_btn':          { en: 'ADD POSITION',           ru: 'ДОБАВИТЬ' },
  'portfolio.ph.question':      { en: 'Will X happen by Y date?', ru: 'Произойдёт ли X к дате Y?' },
  'portfolio.ph.entry':         { en: 'e.g. 42',               ru: 'напр. 42' },
  'portfolio.ph.fair':          { en: 'e.g. 58',               ru: 'напр. 58' },
  'portfolio.ph.topic':         { en: 'iran, crypto, election...', ru: 'иран, крипто, выборы...' },
  'portfolio.ph.thesis':        { en: 'Why do you have edge here?', ru: 'Почему у вас есть преимущество?' },
