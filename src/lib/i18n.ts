...
const translations = {
  ...
  'auth.subtitle':         { en: 'markets · sports · esports · crypto', ru: 'рынки · спорт · киберспорт · крипто' },
  ...
  'auth.desc':             { en: 'AI-powered intelligence across prediction markets, sports, esports, and crypto. One platform to find mispriced probability before the crowd corrects it.', ru: 'AI-аналитика предсказательных рынков, спорта, киберспорта и крипто. Одна платформа — найди неверно оценённую вероятность раньше толпы.' },
