...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/feed`,     lastModified: now, changeFrequency: 'hourly',  priority: 0.85 },
    { url: `${base}/dota`,     lastModified: now, changeFrequency: 'hourly',  priority: 0.8 },
    { url: `${base}/sport`,    lastModified: now, changeFrequency: 'hourly',  priority: 0.8 },
